      ...
      <el-col :span="6" style="margin-top: 16px; padding-left: 12px; padding-right: 12px">
        ...
        >
          <el-form-item label="课程号" prop="cid">
            <el-input clearable v-model="form.cid"></el-input>
          </el-form-item>
          <el-form-item label="课程名">
            <el-input clearable v-model="form.name"></el-input>
          </el-form-item>
          <el-form-item label="先行课">
            <el-input clearable v-model="form.fcid"></el-input>
          </el-form-item>
          <el-form-item label="学分">
            ...
            <el-col :span="12">
              <el-form-item placeholder="输入学分筛选" style="width: 100%;">
                <el-input clearable v-model.number="form.credit"></el-input>
              </el-form-item>
            </el-col>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  methods: {
    get() {
      ...
      this.$axios.getCourse(_this.form).then(
        response => {
          // 成功回调
    ...
    post(formName) {
      ...
      _this.$refs[formName].validate((valid) => {
        if (!valid) return false;
          ...
          _this.ploading = true;
          console.log(_this.form);
          _this.$axios.postCourse(_this.form).then(
            response => {
              // 成功回调
    ...
    handleDelete(index, row) {
      let data = { tablename: "course", id: row.cid }
    ...
    handleCheck(index, row) {
      ...
      if(data.cid != oldData.cid)
      {
        data.old_cid = oldData.cid;
      }
      this.$axios.postCourse(data).then(
        response => {
          // 成功回调
          var res = response.data;
          console.log(res);
